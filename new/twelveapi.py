...
from new.analyse import analyze_pair
from new.enterpionts import check_entry_point, get_current_price
from new.telegram import send_enter_point_message, send_closing_message, send_telegram_message
